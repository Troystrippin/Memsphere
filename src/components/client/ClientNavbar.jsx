...
import RenewMembershipModal from "../../pages/RenewMembershipModal";
import {
  Bell,
  User,
  Settings,
...
const ClientNavbar = ({ profile, avatarUrl, unreadCount: propUnreadCount }) => {
  ...
  const handleNotificationClick = async (notification) => {
    ...
    // Navigate to notifications page with highlight parameter for other notifications
  ...
  const getNotificationIcon = (type) => {
    const iconMap = {
      ...
      membership_expiring: <Clock className="w-5 h-5 text-yellow-500" />,
      membership_expired: <AlertCircle className="w-5 h-5 text-red-500" />,
      ...
      application_submitted: <Mail className="w-5 h-5 text-blue-500" />,
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        {unreadCount > 0 && (
                          <button
                            ...
                            className={`text-sm font-medium flex items-center gap-1 px-3 py-1.5 rounded-lg shadow-sm hover:shadow transition-all whitespace-nowrap ${
                              isDarkMode
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {notificationData.planName && (
                                  ...
                                  >
                                    <Crown size={10} />
                                    {notificationData.planName} Plan
                                  </p>
                                )}
                              </div>
                              {!notification.is_read && (
                                <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse flex-shrink-0 mt-2"></span>
                              )}
                            </div>
                          );
                        })
