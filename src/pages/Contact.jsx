          ...
          {contactInfo.map((info) => {
            ...
            return (
              <a
                ...
                className={`contact-card group relative rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden ${isDarkMode ? "dark-mode" : "bg-white"}`}
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`w-16 h-16 ${isDarkMode ? "bg-gray-700 group-hover:bg-white/20" : info.bgColor} rounded-2xl flex items-center justify-center mb-4 group-hover:bg-white/20 group-hover:backdrop-blur-sm transition-all duration-300`}
                  >
                    <Icon
                      className={`w-8 h-8 ${isDarkMode ? "text-blue-400 group-hover:text-white" : info.textColor} group-hover:text-white transition-colors duration-300`}
                    />
                  </div>
                  <h3
                    className={`text-lg font-semibold mb-1 ${isDarkMode ? "text-white group-hover:text-white" : "text-gray-900"} group-hover:text-white transition-colors duration-300`}
                  >
                    {info.platform}
                  </h3>
                  <p
                    className={`${isDarkMode ? "text-gray-400 group-hover:text-white/90" : "text-gray-600"} group-hover:text-white/90 transition-colors duration-300`}
                  >
                    {info.value}
                  </p>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq) => (
              <div
                key={faq.id}
                className={`faq-card rounded-xl shadow-md overflow-hidden group hover:shadow-lg transition-all duration-300 ${isDarkMode ? "bg-gray-700 hover:bg-gray-600" : "bg-white"}`}
              >
                <div className="p-6">
                  <h3
                    className={`text-lg font-semibold mb-2 ${isDarkMode ? "text-white group-hover:text-blue-400" : "text-gray-900 group-hover:text-blue-600"} transition-colors`}
                  >
                    {faq.question}
                  </h3>
                  <p
