...
const Profile = () => {
  ...
  const getPaymentMethodLabel = (method) => {
    switch(method) {
      ...
      case 'onsite': return 'Pay at Business';
                ...
                <div className="profile-details">
                  ...
                  {userData.business_name && userData.role === 'owner' && (
                    <div className="detail-item">
                      ...
                      <span className="detail-value">{userData.business_name}</span>
                    </div>
                  )}
                  <div className="detail-item">
          ...
          <div className="memberships-section">
            ...
            {loadingMemberships ? (
                  ...
                  <div key={membership.id} className="membership-card">
                    ...
                    <div className="membership-card-body">
                      <div className="plan-info">
                        ...
                        <div className="plan-price">
                          ...
                          <span className="plan-duration">/{membership.plans?.duration}</span>
                        </div>
                      </div>
                      ...
                      <div className="payment-method-display">
                        ...
                        <span className="payment-method-text">
                          Payment: {getPaymentMethodLabel(membership.payment_method)}
                        </span>
                      </div>
                      ...
                      <div className="membership-dates">
                        <div className="date-item">
                          ...
                          <span className="date-value">{formatDate(membership.created_at)}</span>
                        </div>
                        {membership.end_date && (
                          <div className="date-item">
                            <span className="date-label">Valid until:</span>
                            <span className="date-value">{formatDate(membership.end_date)}</span>
                          </div>
                        )}
                      </div>
                      
                      {membership.plans?.features && membership.plans.features.length > 0 && (
                        <div className="plan-features">
                          <p className="features-label">Features:</p>
                          <div className="features-list">
                            {membership.plans.features.slice(0, 3).map((feature, idx) => (
                              <span key={idx} className="feature-tag">{feature}</span>
                            ))}
                            {membership.plans.features.length > 3 && (
                              <span className="feature-tag more">+{membership.plans.features.length - 3}</span>
                            )}
                          </div>
                        </div>
                      )}
                    ...
                    <div className="membership-card-footer">
                      <span className="business-location">
                        ...
                        {membership.businesses?.location || 'Location not specified'}
                      </span>
                      <button 
              ...
              <div className="no-memberships">
                ...
                <p>You haven't joined any businesses yet or your memberships are pending approval.</p>
                <button 
